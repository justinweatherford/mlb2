  ...
  return (
    <div className="flex h-screen bg-[#07090f] overflow-hidden">
      <aside
        ...
        style={{ background: '#090d1a', borderRight: '1px solid #1a2540' }}
        aria-label="Navigation"
      >
        <div className="px-4 py-4 border-b border-[#1a2540]">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded bg-blue-600/20 border border-blue-700/40 flex items-center justify-center flex-shrink-0">
              <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} aria-hidden>
